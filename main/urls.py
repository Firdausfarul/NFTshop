...
from main.views import show_main, create_product, show_xml, show_json, show_xml_by_id, show_json_by_id , register, login_user, logout_user, delete_product, increase_amount, decrease_amount, get_product_json, add_product_ajax, get_product_json_by_user_id
app_name = 'main'
